...
function Login({ onSwitchToSignup, onAuthSuccess }: LoginProps) {
  ...
  return (
    <div className="page">
      <main className="card" aria-label="Login form">
        <div className="crest" aria-hidden />

        <div className="brand">
          <p className="brand-title">Login to confirm your booking</p>
        </div>
        ...
        <p className="footer">Don&apos;t have an account? <a href="#" onClick={(e) => { e.preventDefault(); onSwitchToSignup?.() }}>Sign up</a></p>
      </main>
    </div>
  )
}
